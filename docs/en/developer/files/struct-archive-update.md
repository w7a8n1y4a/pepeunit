...
1. The [target version](/en/development-pepeunit/mechanics/update-system#алгоритм-вычисления-текущеи-версии-unit) is calculated.
1. [env.json](/en/definitions#env-json) and [schema.json](/en/definitions#schema-json) are added based on the [target version](/en/development-pepeunit/mechanics/update-system#алгоритм-вычисления-текущеи-версии-unit).
1. The [target version](/en/development-pepeunit/mechanics/update-system#алгоритм-вычисления-текущеи-версии-unit) is written into [env.json](/en/definitions#env-json) as `PU_COMMIT_VERSION`.
