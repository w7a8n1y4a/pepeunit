...
[env.json](/en/definitions#env-json) is a four‑party contract between the [Unit](/en/definitions#unit), [Pepeunit](/en/conception/overview), the [User](/en/development-pepeunit/mechanics/roles#user), and the [Administrator](/en/development-pepeunit/mechanics/roles#admin) of the [Pepeunit](/en/conception/overview) instance:
...
1. [Pepeunit](/en/conception/overview) guarantees to all parties that [env.json](/en/definitions#env-json) will be stored in [encrypted form](/en/development-pepeunit/mechanics/cipher).
