...
### Сценарий 10 - Проверка удаляемости Repo
...
### Сценарий 5 - Запуск контура инфраструктуры
...
### Сценарий 6 - Обновление Unit напрямую
...
### Сценарий 7 - Обновление Unit автоматически
...
### Сценарий 11 - Множественная выборка Unit
- Выборка по создателю
- Выборка по Repo
- Выборка по автообновляемости

### Сценарий 12 - Множественная выборка UnitNode
- Выборка по Unit

### Сценарий 13 - Удаление
- Удалить Unit