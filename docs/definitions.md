...
## OTA
`Over The Air` - обновление по воздуху, способ доставки и установки новых микропрограм в [IoT](#iot) устройства. [Pepeunit](/conception/overview) поддерживает обновление по `OTA` через [REST](#rest) и отдаёт три вида архивов:
