...
:::danger
Администратор имеющий доступ к .env файлу бэкенда инстанса Pepeunit, имеет возможность расшифровать данные хранящиеся в шифрованном виде на его инстансе.

Поэтому используйте только инстансы Pepeunit администраторам которых вы доверяете.
