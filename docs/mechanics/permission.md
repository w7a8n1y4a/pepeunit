...
Это означает что [Пользователь](/mechanics/roles.html#user) может найти вашу сущность через поиск и выполнить ряд манипуляции описаных в [возможностях агентов для видимых сущностей](/mechanics/visibility#возможности-агентов-для-видимых-сущностеи)
:::
