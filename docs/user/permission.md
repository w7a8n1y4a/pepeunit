...
Это означает что [Пользователь](/development-pepeunit/mechanics/roles.html#user) может найти вашу сущность через поиск и выполнить ряд манипуляции описаных в [возможностях агентов для видимых сущностей](/development-pepeunit/mechanics/visibility#возможности-агентов-для-видимых-сущностеи)
:::
