...
Обычно разработчики [Repo](/definitions#repo) преднастраивают их для корректной работы [Unit](/definitions#unit), но часть из них, как например: `WIFI_SSID` и `WIFI_PASS` - нужно заполнить вашими данными.
