...
:::info
Если у вашего [DataPipe](/definitions#datapip) уже есть данные, то при синхронизации, [Pepeunit](/conception/overview) вычленит ключи и запишет их в `columns` у `Datasource`, что позволит не заполнять их руками
:::
