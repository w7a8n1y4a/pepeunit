...
1. Cкомпилированную часть из вкладки `Compiled Firmware Platforms`, содержащей ссылки на платформы текущей [таргет версии](/developer/update-system#алгоритм-вычисления-текущеи-версии-unit) [Unit](/definitions#unit).
