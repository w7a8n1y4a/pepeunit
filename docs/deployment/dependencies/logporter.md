...
:::info
`Logporter` в [Pepeunit](/conception/overview) используется по прямому назначению - собирать логи всех контейенеров доступных через `/var/run/docker.sock:ro` и отправки этих данных в [Prometheus](/deployment/dependencies/prometheus)
:::