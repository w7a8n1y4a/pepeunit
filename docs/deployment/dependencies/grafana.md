...
[Grafana](https://grafana.com/) - платформа с открытым исходным кодом, для визуализации данных и их анализа. [Подробнее о переменных окружения](/deployment/env-variables/grafana)

:::info
Встроена в структуру работы [Pepeunit](/conception/overview) для визуализации данных из [DataPipe](/deployment/dependencies/datapipe) и отображения данных [Мониторинга](/deployment/monitoring).
:::
