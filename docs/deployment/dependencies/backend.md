...
В широком смысле, главный из `6` компонентов - `Backend`. Размещается на сервере и обеспечивает обработку, хранение и анализ информации. Реализует интеграции с остальными `5` сервисами, а также взаимодействует с другими агентами с использованием [API](/definitions#api):
