...
`PU_DP_BUFFER_FLUSH_INTERVAL` | `5` | Период времени в секундах, по истечении которого, независимо от числа пришедших записей, данные будут сохранены в [ClickHouse](/deployment/dependencies/clickhouse) или [PostgreSQL](/deployment/dependencies/postgresql)
