...
Control panel on sh1106 | `Micropython` | `esp32`, `esp32c3`, `esp32s3` | [GitLab](https://git.pepemoss.com/pepe/pepeunit/units/esp32/control_panel_sh1106) | [GitHub](https://github.com/w7a8n1y4a/control_panel_sh1106) | `pepeunit_micropython_client`
