...
[Пользователь](/development-pepeunit/mechanics/roles#user) может найти вашу сущность через поиск и выполнить ряд манипуляций, описаных в [возможностях агентов для видимых сущностей](/development-pepeunit/mechanics/visibility#возможности-агентов-для-видимых-сущностеи)
:::
