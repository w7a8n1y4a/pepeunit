...
[Пользователь](/development-pepeunit/mechanics/roles.html#user) может найти вашу сущность через поиск и выполнить ряд манипуляций, описаных в [возможностях агентов для видимых сущностей](/development-pepeunit/mechanics/visibility#возможности-агентов-для-видимых-сущностеи)
:::
...
1. Вы попадёте в меню, где указаны агенты, которые могут взаимодействовать с данной сущностью
