...
## ESP-IDF
[ESP-IDF](https://docs.espressif.com/projects/esp-idf/) - официальный фреймворк компании `Espressif` для разработки прошивок на языках `C` и `C++` для микроконтроллеров семейства `ESP32`.
