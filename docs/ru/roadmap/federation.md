...
1. Возможно нужен middleware сервис на golang, который сможет также быть bridge мостом трафика между mqtt и rest/websocket и тд, от внешних инстансов
1. Топики данных, data pipe отдают накопленные данные через это строится федерация
...
1. Для публичных UnitNode, возможность создать связь между инстансами для получения данных с qos хотя бы 1
