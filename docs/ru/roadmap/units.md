...
1. ff_ тип борьбы с пропадением связи
...
1. Типы нажатий:
    ...
    - тройное
    - длинное
1. Обработка дебаунса
1. Установка сообщений для каждого типа нажатий через env - отдельный топик для этого - отдельный топик для кнопки
1. Отдельный топик для кнопки - one, double, triple, long
1. Вращение энкодера право лево - отдельный топик для энкодера right/left
