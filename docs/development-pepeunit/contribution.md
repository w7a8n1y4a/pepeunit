...
:::info
Система именования коммитов [COMMITLINT](https://commitlint.online/commitlint_d-oh/dist/) - помогает быстро понять суть каждого изменения, и улучшает прозрачность истории разработки.
