...
:::danger
Разработчики [Unit](/definitions#unit) всегда могут применить дополнительное шифрование поверх текстовых данных, которое сочтут нужным. Например алгоритм `aes256` на основе `PU_SECRET_KEY` встроен в [клиентские библиотеки](/developer/libraries/framework).
:::
