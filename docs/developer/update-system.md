...
1. Pepeunit выполняет вызывов MQTT команды UPDATE - update/pepeunit - для каждого Unit у которого указано автоматическое обновление
...
1. Pepeunit выполняет вызывов MQTT команды UPDATE - update/pepeunit - для каждого Unit у которого указано автоматическое обновление и родительский Repo которого присутствует в выборке