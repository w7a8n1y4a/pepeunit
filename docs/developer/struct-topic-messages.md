...
### DataPipe
Для простых сообщений текстом и числами, можно организовать обработку через [DataPipe](/definitions#datapipe). [Подробнее о настройке DataPipe](/user/settings-unit-node#datapipe)
