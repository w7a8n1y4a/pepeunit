...
::: danger
Используйте только доверенные инстансы [Pepeunit](/conception/overview). Следите, чтобы [Администратор](/development-pepeunit/mechanics/roles#admin) инстанса [Pepeunit](/conception/overview) выполнял свои контрактные обязательства, связанные с [env.json](/definitions#env-json).
:::
