...
Для микроконтроллеров в [Pepeunit](/conception/overview) есть система очистки репозитория перед генерацией архива с программой. Данный алгоритм удаляет определённые файлы и директории. Подробнее об этой механике можно узнать в разделе [структура архивов с обновлениями](/developer/files/struct-archive-update).
:::
