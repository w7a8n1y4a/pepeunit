...
1. Добавить в тестовый клиент, обновелине env.json
1. Unit могут хранить логи локально о сбоях, при старте они могут отдавать логи сразу большим пакетом, нужно множественное сохранение логов
1. Нужна команда log_sync для принудительной синхронизации логов
