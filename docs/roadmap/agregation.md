...
1. Сохраняет файл в minio если тип соответствует, ttl задаётся из настроек
...
1. Проверяет что число записей для данного топика не превышает заданное, удаляет 0 запись если есть превышение
1. Сохраняет файл в minio если тип соответствует, ttl задаётся из настроек
