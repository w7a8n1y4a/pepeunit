...
1. Если текущий размер репозитория, превышает порог из env, то ему ставится спец ошибка обновления, и пока эта ошибка не будет поправлена, он не обновится. Бекенд будет смотреть размер из стейта внешнего репозитория или скачивать и смотреть реальный размер
